 ...
 * @since      0.1.0
 *
 * @package    Exchange_Flickr_Images
 * @subpackage Exchange_Flickr_Images/admin
 */
...
class Exchange_Flickr_Images {
	...
	public function __construct() {
		...
		$this->name = 'exchange-flickr-images';
		$this->version = '1.0.0';
	...
	public function add_meta_box() {
		...
		$screens = array( 'post', 'page', 'story', 'collaboration' );

		foreach ( $screens as $screen ) {
			add_meta_box(
				$this->name,
				'Insert from Flickr & Instagram',
